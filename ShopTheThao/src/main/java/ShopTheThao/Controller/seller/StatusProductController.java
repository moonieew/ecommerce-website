...
@WebServlet(urlPatterns = {"/seller/status"})
public class StatusProductController extends HttpServlet{

	/**
	 * 
	 */
	private static final long serialVersionUID = 4864092350989530930L;
