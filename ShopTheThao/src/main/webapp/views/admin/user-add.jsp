				...
				<form method="post" action="useradd">
					...
					<div class="pl-lg-4">
						<div class="row">
							<div class="col-lg-6">
								<div class="form-group">
									<label class="form-control-label" for="input-username">Tên
							...
							<div class="col-lg-6">
								<div class="form-group">
									<label class="form-control-label" for="input-username">Mật
										khẩu</label> <input type="text" name="password" id="input-username"
						...
						<div class="row">
							...
							<div class="col-lg-3">
								<div class="form-group">
									<label class="form-control-label" for="input-email">Quyền</label>
									<select name="roleId" id="gender" class="custom-select"
										required>
							...
							<div class="col-lg-4">
								<div class="form-group">
									<label class="form-control-label" for="input-city">Số
										...
										class="form-control" placeholder="0914282920" required />
								</div>
							</div>
							<hr class="my-4" />
							<div class="col-lg-2">
